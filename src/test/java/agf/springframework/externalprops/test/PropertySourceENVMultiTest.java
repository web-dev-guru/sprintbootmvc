...
import agf.springframework.externalprops.configure.env.ExternalPropsEnvironmentMultiple;
...
@ContextConfiguration(classes = ExternalPropsEnvironmentMultiple.class)
public class PropertySourceENVMultiTest {
    ...
    public void testPropsSet() throws Exception {
        ...
        assertEquals("asdf", dbobj.getPassword());
    }
}
